...
export function CanvasAreaV2() {
  ...
  return (
    ...
    >
      {/* Migration indicator */}
      <div className="absolute top-6 left-6 z-30 bg-green-100 border border-green-300 rounded-lg px-2 py-1 text-xs text-green-800">
        🚀 Using Zustand Canvas (V2)
      </div>
