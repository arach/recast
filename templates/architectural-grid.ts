...
// Architectural Grid - Clean modernist architectural elements for design/construction brands
...
export function draw(
  ...
  bgGradient.addColorStop(1, '#f4f4f4');
  ...
  renderBuildingStructure(ctx, buildingStructure, materialColors, structuralDepth, materialHonesty);
  ...
  function renderStructuralGrid(ctx: CanvasRenderingContext2D, structure: any[], colors: any, density: number, weight: number, scale: number) {
    ctx.save();
  ...
  function renderBuildingStructure(ctx: CanvasRenderingContext2D, structure: any[], colors: any, depth: number, honesty: number) {
    ctx.save();
    
    // Main structural body
    const bounds = getBounds(structure);
    
    // Material-honest gradient
    const structuralGradient = ctx.createLinearGradient(
      bounds.minX, bounds.minY,
      bounds.maxX, bounds.maxY
    );
    
    structuralGradient.addColorStop(0, colors.light);
    structuralGradient.addColorStop(0.3, colors.primary);
    structuralGradient.addColorStop(0.7, colors.structural);
    structuralGradient.addColorStop(1, colors.dark);
    
    ctx.fillStyle = structuralGradient;
    drawArchitecturalPath(ctx, structure);
    ctx.fill();
    
    // Structural edge with honesty
    ctx.strokeStyle = colors.dark;
    ctx.lineWidth = 1 + honesty * 2;
  ...
  function renderArchitecturalDetails(ctx: CanvasRenderingContext2D, structure: any[], colors: any, weight: number, sharpness: number, expression: number) {
    ctx.save();
  ...
  function renderFenestration(ctx: CanvasRenderingContext2D, structure: any[], colors: any, fenestration: number, modularity: number, scale: number) {
    ctx.save();
  ...
  function renderCurtainWall(ctx: CanvasRenderingContext2D, structure: any[], colors: any, curtainWall: number, density: number, scale: number) {
    ctx.save();
  ...
  function renderCantilevers(ctx: CanvasRenderingContext2D, structure: any[], colors: any, cantilevers: number, depth: number, scale: number) {
    ctx.save();
  ...
  function renderSurfaceTexture(ctx: CanvasRenderingContext2D, structure: any[], colors: any, texture: number, materialType: number) {
    ctx.save();
  ...
  function drawArchitecturalPath(ctx: CanvasRenderingContext2D, points: any[]) {
