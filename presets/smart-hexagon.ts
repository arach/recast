...
// Smart Hexagon - Modern structured brands with variable geometry
export const parameters: Record<string, ParameterDefinition> = {
  ...
  strokeStyle: {
    ...
    step: 1,
    default: 1,
    label: 'Stroke (0=None, 1=Clean, 2=Double, 3=Gradient, 4=Animated)'
  },
  ...
  fillStyle: {
    ...
    step: 1,
    default: 2,
    label: 'Fill (0=None, 1=Solid, 2=Linear, 3=Radial, 4=Geometric)'
  },
...
export function draw(
  ...
  function generateSmartHexagon(style: number, centerX: number, centerY: number, radius: number, aspectRatio: number, rotation: number, edgeVar: number, symmetryBreak: number, time: number, layer: number) {
    const points = [];
    const baseAngles = 6;
  ...
  function createCorporatePalette(hue: number, corporate: number, modernity: number) {
  ...
  function renderInnerShadow(ctx: CanvasRenderingContext2D, points: any[], colors: any, shadow: number, cornerRadius: number) {
    ctx.save();
  ...
  function renderHexagonFill(ctx: CanvasRenderingContext2D, points: any[], colors: any, fillStyle: number, alpha: number, centerX: number, centerY: number, radius: number) {
    ctx.save();
  ...
  function renderProfessionalStroke(ctx: CanvasRenderingContext2D, points: any[], colors: any, strokeStyle: number, weight: number, cornerRadius: number, time: number, layer: number) {
    ctx.save();
  ...
  function renderSurfaceHighlight(ctx: CanvasRenderingContext2D, points: any[], colors: any, sheen: number, centerX: number, centerY: number) {
    ctx.save();
  ...
  function drawRoundedHexagon(ctx: CanvasRenderingContext2D, points: any[], radius: number) {
