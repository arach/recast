 ...
 * 🎯 Isometric Wordmark
 * 
 * Premium interactive Three.js-powered isometric wordmark with orbit controls
...
function draw(ctx, width, height, params, time, utils) {
  ...
  if (p.enableOrbitControls) {
    ...
    // Update scene
    scene.background = new THREE.Color(p.backgroundColor || '#f0f2f5');
...
export const parameters = {
  ...
  backgroundColor: color('#f0f2f5', 'Background Color', { group: 'Visual Style' }),
...
export const metadata = {
  id: 'isometric-wordmark',
  name: "🎯 Isometric Wordmark",
  description: "Premium interactive 3D isometric wordmark with full orbit controls",
  parameters,
  defaultParams: {
    wordmark: 'ReFlow',
    textSize: 28,
